...
export const InnocreProvider = ({ children }) => {
  ...
  const buyTokens = async () => {
    ...
    console.log(innocreCoinAddress);

    let options = {
      contractAddress: innocreCoinAddress,
      functionName: "mint",
      abi: innocreAbi,
      msgValue: calcPrice,
      params: {
